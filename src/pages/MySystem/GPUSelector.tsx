...
import { getGpuOptions } from '../../services/systemService'
...
export default function GPUSelector({ value, onChange, token, error }: Props) {
    ...
    <div className="relative">
      ...
      >
        <span className={selectedOption ? 'text-white' : 'text-gaming-secondary'}>
          {selectedOption ? selectedOption.name : 'Select a graphics card...'}
        </span>
        <ChevronDown
          size={20}
