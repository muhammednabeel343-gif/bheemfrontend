...
import { getCpuOptions } from '../../services/systemService'
...
export default function CPUSelector({ value, onChange, token, error }: Props) {
    ...
    <div className="relative">
      ...
      >
        <span className={selectedOption ? 'text-white' : 'text-gaming-secondary'}>
          {selectedOption ? selectedOption.name : 'Select a processor...'}
        </span>
        <ChevronDown
          size={20}
